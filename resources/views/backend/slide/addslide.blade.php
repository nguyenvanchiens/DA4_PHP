                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" value="" id="" name="name_shop" minlength="2" type="text" required="">
                                        </div>
                                    </div>     
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Tiêu Đề</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" value="" id="" name="header" minlength="2" type="text" required="">
                                        </div>
                                    </div>     
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Nội Dung</label>
                                        <div class="col-lg-6">
                                            <textarea class='ckeditor' required  name="content" id="" cols="30" rows="10"></textarea>
