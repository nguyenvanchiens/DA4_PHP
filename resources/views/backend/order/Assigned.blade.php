...
<section id="main-content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      DANH SÁCH ĐƠN HÀNG ĐÃ XÁC THỰC
    </div>
          ...
          @endforeach
            <tr class="text-center">
              ...
              @endif
                ...
                <td>
                  <a href="{{ asset('admin/order/delivery/'.$item->id) }}" data-url="" class="btn btn-sm btn-primary action_delete"><i class="fas fa-car-side"></i>Giao</a>
