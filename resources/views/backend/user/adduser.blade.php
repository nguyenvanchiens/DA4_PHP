                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="POST" action="" novalidate="novalidate">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" value="" id="name" name="name" type="text" required="">           
                                            @if (Session::has('name'))
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" value="" id="email" name="email" type="email" required="">         
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" value="" id="password" name="password" type="text" required="">           
                                        </div>
                                    </div>       
                                    <div class="form-group ">
